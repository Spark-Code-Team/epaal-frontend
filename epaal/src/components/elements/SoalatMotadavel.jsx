...
const SoalatMotadavel = ()=>{
    ...
    const items = [
        ...
        {id:2 , title:"مراحل دریافت وام خرید اعتباری چگونه است؟" ,  description:"در سایت دیجی‌شهر ثبت‌نام کنید و اطلاعات شخصی و شغلی خود را ثبت کنید."},
        {id:3 , title:"وام دیجی‌شهر به چه صورتی قابل استفاده است؟" ,  description:"وام شما بصورت اعتبار برای خرید کالا از فروشگاه آنلاین دیجی‌شهر قابل استفاده است. لینک سایت فروشگاه: https://dgshahr.com/shop"} ,
        {id:4 , title:"سقف دریافت اعتبار چقدر است؟ " ,  description:"سقف وام قابل دریافت بستگی به ارزیابی رفتار بانکی و نوع ضمانت شما دارد که می‌تواند تا ۲۰۰ میلیون تومان باشد. "} ,
    ]
