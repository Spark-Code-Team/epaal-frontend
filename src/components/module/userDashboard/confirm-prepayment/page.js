      ...
      <div className="w-full">
        ...
        <div className="my-10 flex flex-col rounded-3xl bg-gray-200 px-5 py-10 gap-3">
          <div className="font-extrabold  text-lg">
            <p>اشتراک "زرمایه" چیست؟</p>
          </div>
          <div>
            <p>
              زرمایه بستر ارائه اعتبار خرید کالا یا خدمات در سراسر ایران است، لذا شما با خرید اشتراک زرمایه میتوانید پس از گذراندن مراحل اخذ اعتبار، بصورت اقساطی تمامی کالاها یا خدمات مدنظر خود را از طریق این پلتفرم بصورت حضوری یا برخط (آنلاین) تهیه نمایید.
            </p>
          </div>
          <div className="font-extrabold  text-lg">
            <p>توجه:</p>
          ...
          <div>
            ...
            <p>
              با پرداخت این اشتراک قادر به اخذ اعتبار از یکی از فرآیندهای اعتباردهی زرمایه خواهید بود و برای فعالسازی طرح های بیشتر با پشتیبانی تماس حاصل فرمایید.
