        ...
        <>
            ...
            <div id="container" className="w-full h-auto">
                ...
                استان تهران، خیابان پاسداران، بوستان پنجم، پلاک 84
                    ...
                    <div>
                        <p> و کدپستی: {digitsEnToFa("1664674111")}</p>ب
                    </div>
                    <div>
                ...
                <div
                    className={`mb-10 w-4/5 cursor-pointer mx-auto rounded-lg ${status == "submit_physical" ? "text-white bg-evaamGreen" : "text-gray-400 bg-gray-200"} px-5 py-2 text-center font-semibold `}
