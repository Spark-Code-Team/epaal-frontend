...
export default function UserSidebar() {
    ...
    return (
        <>
            {/* side bar in mobile */}
            <div
                className="fixed left-1/2 top-5 z-10 flex w-[85%] -translate-x-1/2 transform flex-row items-center justify-between rounded-3xl bg-evaamBorderColor p-4 px-6 text-black md:static md:hidden">
                <div
                    id="right"
                ...
                >
                    <div
                        className="flex h-8 w-8 items-center justify-center rounded-lg border border-evaamGreen bg-none">
