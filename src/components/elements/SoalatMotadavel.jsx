...
const SoalatMotadavel = ()=>{
    ...
    const items = [
        ...
        {id:2 , title:"مراحل دریافت وام خرید اعتباری چگونه است؟" ,  description:"در سایت زرمایه ثبت‌نام کنید و اطلاعات شخصی و شغلی خود را ثبت کنید."},
        {id:3 , title:"وام زرمایه به چه صورتی قابل استفاده است؟" ,  description:"وام شما بصورت اعتبار برای خرید کالا از فروشگاه آنلاین زرمایه قابل استفاده است. لینک سایت فروشگاه: https://dgshahr.com/shop"} ,
