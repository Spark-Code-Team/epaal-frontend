...
const LoanApplicationProcess = ()=>{
    ...
    const items = [
        {id:1 , title:"ثبت درخواست" , icon:"/image/13.webp" ,  description:"با مراجعه به سایت زرمایه و کلیک روی گزینه درخواست وام، وارد پنل کاربری شوید."},
        ...
        {id:4 , title:"بررسی مدارک" , icon:"/image/16.webp" ,  description:"پس از بررسی‌ مدارک و اطلاعات‌ وارد شده، پشتیبانی زرمایه با شما تماس می‌گیرد و هماهنگی‌های لازم انجام می‌شود."} ,
        {id:5 , title:"شارژ کیف پول" , icon:"/image/17.webp" ,  description:"پس از تایید بانک، کیف پولتان در فروشگاه زرمایه شارژ شده و می‌توانید کالای دلخواه خود را به صورت قسطی خریداری کنید."}
    ]
