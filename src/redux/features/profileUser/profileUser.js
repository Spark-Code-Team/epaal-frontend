  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(fetchProfile.fulfilled, (state, action) => {
      ...
      state.shamsi_birthday_date =
        action.payload.response.data.data.shamsi_birthday_date;
      ...
      state.confirmed_address =
        action.payload.response.data.data.confirmed_address;
      state.phone_number = action.payload.response.data.data.phone_number;
      state.second_phone_number =
        action.payload.response.data.data.second_phone_number;
